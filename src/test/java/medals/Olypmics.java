...
public class Olypmics {
	String url = "https://en.wikipedia.org/wiki/2016_Summer_Olympics#Medal_table";
	 WebDriver driver;
	    List<String> silverCountries = new ArrayList<>();
	    List<String> bronzeCountries = new ArrayList<>();
	    ...
	    public void TestCase1() throws InterruptedException {
	        ...
	        data = driver.findElements(
	                By.xpath("//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr"));
	        List<String> orderNumDes = new ArrayList<>();
	        for (int i = 0; i < data.size() - 1; i++) {
	            String xpath = "//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr[" + (i + 1)
	                    + "]/td[1]";
	            String tdData = driver.findElement(By.xpath(xpath)).getText();
	    ...
	    public String mostGold(List<WebElement> list) {
	        Map<String, Integer> GoldMedal = new HashMap<>();
	        String result = "";
	        for (int i = 0; i < list.size(); i++) {
	            String MedalXpath = "//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr["
	                    + (i + 1) + "]/td[2]";
	    ...
	    public String mostSilver(List<WebElement> list) {
	        Map<String, Integer> SilverMedal = new HashMap<>();
	        String result = "";
	        for (int i = 0; i < list.size(); i++) {
	            String MedalXpath = "//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr["
	                    + (i + 1) + "]/td[3]";
	    ...
	    public String mostBronz(List<WebElement> list) {
	        Map<String, Integer> BronzMedal = new HashMap<>();
	        String result = "";
	        for (int i = 0; i < list.size(); i++) {
	            String MedalXpath = "//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr["
	                    + (i + 1) + "]/td[4]";
	    ...
	    public List<String> sum18(int sum) {
	        ...
	        for (int i = 0; i < data.size() - 1; i++) {
	            for (int j = i + 1; j < data.size() - 1; j++) {
	                String xpath = "//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr["
	                        + (i + 1) + "]/td[4]";
	                String xpath1 = "//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr["
	                        + (j + 1) + "]/td[4]";
	                ...
	                if ((tdData + tdData1) == sum) {
	                    String country = driver.findElement(
	                            By.xpath("//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr["
	                                    + (i + 1) + "]/th"))
	                            .getText();
	                    String country1 = driver.findElement(
	                            By.xpath("//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr["
	                                    + (j + 1) + "]/th"))
	                            .getText();
